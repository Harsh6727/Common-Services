...
import '../dashboard/ServiceButton.css';
import Link from "next/link";
import img from './health-services/health.jpeg'
        ...
        <div className="row">
          <div className="container">
            ...
            <div className="buttons">
              <Link href="http://localhost:3000/dashboard/health-services" className="btn">Visit</Link>
            </div>
          </div>
        </div>
      </div>
